// src/lib.rs
/*
 * Core library for CryptoTreasure
 */
...
#[derive(Debug)]
pub struct CryptoTreasureProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoTreasureProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoTreasure processing");
    
    let mut processor = CryptoTreasureProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoTreasureProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoTreasureProcessor::new(false);
